# -*- coding: utf-8 -*-
"""
Created on Fri Mar 18 00:55:55 2016

@author: Kazuki
"""

"item"
items = ['blade','blades','tee','tile','heater','knob','handle','adapter','bolt',
         'paint','water','fuse','fuses','valve','glue','router','screw','screws',
         'faucet','vanity','fan','bag','batteries','stool','stools','block','blocks',
         'drill','post','lights','cabinet','sink','pipe','hose','screwdriver',
         'wire','dryer','bell','storag',
         'toilet','toilets','saw','spray','box','fence',
         'cover','shelf','stone','storage','battery','rugs','stove',
         'range','board','corner','trim','mower','tub',
         'filter','chair','deck','closet',
         'outlet','plate','tool','bar','doors','door',
         'switch','sinks','shower','showerhead',
         'replacement','pressure','rug','cap','kits','washer','blue','filters',
         'panel','bulbs','driver','bulb',
         'carpet','pendant','cleaner','shed','tree','lock',
         'insulation','trimmer','cedar','cabinets','panels','concrete',
         'covers','drop','hole','nails','foam','cord','treated','grill',
         'drywall','bit','lamp','rope',
         'fireplace','track','dishwasher','rod','cable','molding',
         'cadet','screen','oven','flat','brass','green',
         'shelves','vac','pole','pump','tiles','boards','siding','fans',
         'seed','airconditioner','stain','windows','mirror','tape',
         'plates','paper','cub','caps','plug','posts',
         'mdf','roof','stair','pad','flooring',
         'mop','coil','joint','duct','gutter',
         'tools','ladder','fencing','chandelier','decker','tube','connector',
         'compressor','angle','compression','towel','block',
         'gate','porcelain','porch','chain','accessories','rack','seats',
         'refrigerator','roll','sensor','stick','string','pull','spring','screw',
         'washers','bits','bowl','fluorescent','trash','nailer','handles',
         'coating','grid','locking','wallpaper','wall',
         'cushion','pulls','microwave','frame','lite','chairs',
         'freezer','wash','cushions','bed','bags','sander','knife',
         'impact','shades','register','circular','shelving','socket','freezers',
         'drawer','driveway','antique','gauge','pit','bolts','stand','motor',
         'blinds','grinder','tubs','boxes','rust','coupling','lantern','granite',
         'clear','counter','cast','flex','fixture','whirlpool',
         'hanger','side','right','steam',
         'fiberglass','faucets','surge','containers','link','tread','medicine',
         'detector','recessed','slide','backsplash','baseboard','log',
         'cutter','holder','nozzle','charger','pine','cooler','table',
         'breaker','vacuum','storm','grass','valves','ball','trees','iron','interior',
         'sheds','varathane','pergo','soap','bath','bathroom','window','wood']

sparselist = ['blind', 'recess', 'solar', 'chain', 'deck', 'stove',
              'rod', 'rang', 'paper', 'freezer', 'oven', 'bulb', 'fireplac', 
              'corner', 'chair', 'glue', 'toilet', 'carpet', 'impact', 'codeless',
              'secur', 'fenc', 'fiberglass', 'bell', 'mower', 'duct',
              'window', 'concret', 'tape', 'board', 'stain', 'rubbermaid', 'whirlpool', 'knob',
              'plate', 'string', 'grill', 'handl', 'mop', 'vaniti', 'joint', 'electron',
              'dryer', 'grid', 'outlet', 'cushion', 'vacuum', 'cedar', 'bar', 'bit',
              'screwdriv', 'wallpap', 'towel', 'aluinum',
              'nozzl', 'trimmer', 'cooler', 'drop', 'ceram', 'backsplash', 'roll', 'antiqu',
              'bag', 'slide', 'red', 'contain', 'gaug', 'side', 'halogen', 'lantern',
              'copper', 'shed', 'hanger', 'zinc', 'cabl', 'replac', 'frame', 'mdf',
              'tee', 'seat', 'nail', 'pvc', 'pressur', 'roof', 'mirror', 'drywal',
              'blue', 'shower', 'wire', 'closet', 'tube', 'stool', 'insul', 'pump',
              'adapt', 'cutter', 'washer', 'sensor',
              'screen', 'knife', 'nailer', 'cord', 'compact', 'hose', 'led', 'drill',
              'driver', 'porcelain', 'aircondition' 'rug',
              'water', 'spray', 'bolt', 'polyuretha',
              'tub', 'cordless', 'repair', 'valv', 'panel', 'box', 'plywood', 'stone',
              'stair', 'angl', 'steam', 'filter', 'stand', 'stainless', 'router', 'bronz',
              'block', 'pendant', 'medicin', 'heater','plug',
              'cadet', 'cleaner', 'wall', 'pergo', 'bath', 'wash', 'pole', 'fluoresc',
              'motor', 'batteri', 'storag', 'post', 'microwav', 'sander', 'bathroom', 'light',
              'tread', 'coupl', 'vac', 'regist', 'plastic', 'connector', 'paint', 'wood',
              'treat', 'storm', 'spring', 'black', 'white', 'cub', 'flat', 'door',
              'porch', 'shelf', 'tool', 'electr', 'gas', 'faucet', 'oil', 'cabinet',
              'compressor', 'pit', 'gutter', 'link',
              'stick', 'refriger', 'shelv', 'hole', 'granit', 'holder', 'socket', 'steel',
              'pull', 'blade', 'tree', 'bed', 'rack', 'rope', 'cast', 'iron',
              'charger', 'metal', 'grass', 'fixtur',
              'rust', 'driveway', 'trim', 'varathan', 'portabl', 'privaci', 'flex',
              'lock', 'drawer', 'seed', 'right', 'tabl', 'saw', 'showerhead', 'screw',
              'grinder', 'floor', 'mold', 'bowl', 'pine', 'lamp', 'emerg', 'pad',
              'christma', 'lite', 'gate', 'detector',
              'trash', 'soap', 'circular', 'decker',
              'surg', 'sink', 'ball', 'dishwash', 'track', 'ladder', 'foam', 'compress',
              'vinyl', 'rain', 'kit', 'baseboard', 'fuse', 'log', 'coil', 'brass',
              'cap', 'accessori', 'tile', 'liquid', 'glass', 'coat', 'clear', 'counter',
              'cover', 'pipe', 'switch', 'interior',
              'green', 'shade', 'fan', 'breaker', 'chandeli']

typo = [["refridegr","refrig"],
       ["mow","mower"],
        ["mowerer","mower"],
        ['rheum','rheem'],
        ["lawnmow","mower"],
        ...
        ["theomomt","thermomet"],
        ["showerheard","showerhead"],
        ["concretetil","concrete tile"],
        ["ruunner","runner"],
        ["kennal","kennel"],
        ["granuel","granul"],
        ["uplihght","uplight"],
...
typo_google = [['steele stake','steel stake'],
            ['gas mowe','gas mower'],
