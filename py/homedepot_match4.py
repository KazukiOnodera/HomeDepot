...
def match_unmatch(base,prd):
    ...
    li_len0,li_len1,li_len2,li_len3 = [],[],[],[]
...
#    li_t81,li_t82,li_t83,li_t84,li_t85 = [],[],[],[],[]
    ...
    li_t3_01,li_t3_02,li_t3_03,li_t3_04,li_t3_05 = [],[],[],[],[]
    li_t3_06,li_t3_07,li_t3_08,li_t3_09,li_t3_10 = [],[],[],[],[]
    li_t3_11,li_t3_12,li_t3_13,li_t3_14,li_t3_15 = [],[],[],[],[]
    
    li_tt01,li_tt02,li_tt03,li_tt04,li_tt05 = [],[],[],[],[]
    
    li_t_p01,li_t_p02,li_t_p03,li_t_p04,li_t_p05 = [],[],[],[],[]
    li_t_p06,li_t_p07,li_t_p08,li_t_p09,li_t_p10 = [],[],[],[],[]
    ...
    li_d3_01,li_d3_02,li_d3_03,li_d3_04,li_d3_05 = [],[],[],[],[]
    li_d3_06,li_d3_07,li_d3_08,li_d3_09,li_d3_10 = [],[],[],[],[]
    
    li_d_p01,li_d_p02,li_d_p03,li_d_p04,li_d_p05 = [],[],[],[],[]
    li_d_p06,li_d_p07,li_d_p08,li_d_p09,li_d_p10 = [],[],[],[],[]
...
#    
    ...
    li_freq6,li_freq7,li_freq8,li_freq9,li_freq10 = [],[],[],[],[]
    ...
    for i in merged.index:
        ...
        li_t3_01.append(query[3] in tt)
        li_t3_02.append(query[3] == tt[-1])
        li_t3_03.append(hdm.get_ind(query[3],tt))
        li_t3_04.append(hdm.get_ind(query[3],tt[::-1]))
        li_t3_05.append(hdm.is_hit_b4_prepos([query[3]],tt,'in'))
        li_t3_06.append(hdm.is_hit_b4_prepos([query[3]],tt,'with'))
        li_t3_07.append(hdm.is_hit_b4_prepos([query[3]],tt,'for'))
        li_t3_08.append(hdm.is_prepos_after_word(query[3],tt,'in'))
        li_t3_09.append(hdm.is_prepos_after_word(query[3],tt,'with'))
        li_t3_10.append(hdm.is_prepos_after_word(query[3],tt,'for'))
        v1,v2 = hdm.is_part_inc(query[3],tt)
        li_t3_11.append(v1)
        li_t3_12.append(v2)
        ...
        li_t_p03.append(hdm.ispair(query[1:3],tt))
        li_t_p04.append(hdm.ispair(query[1:3][::-1],tt[::-1]))
        li_t_p05.append(hdm.ispair(query[2:4],tt))
        li_t_p06.append(hdm.ispair(query[2:4][::-1],tt[::-1]))
        ...
        li_d3_01.append(query[3] in desc)
        li_d3_02.append(hdm.get_ind(query[3],desc))
        li_d3_03.append(hdm.get_ind(query[3],desc[::-1]))
        li_d3_04.append(query[3] in ''.join(desc))
        li_d3_05.append(desc.count(query[3]))
        
        li_d_p01.append(hdm.ispair(query[:2],desc))
        li_d_p02.append(hdm.ispair(query[:2][::-1],desc[::-1]))
        li_d_p03.append(hdm.ispair(query[1:3],desc))
        li_d_p04.append(hdm.ispair(query[1:3][::-1],desc[::-1]))
        li_d_p05.append(hdm.ispair(query[2:4],desc))
        li_d_p06.append(hdm.ispair(query[2:4][::-1],desc[::-1]))
        ...
        li_freq4.append(hdm.get_freq(query[3]))
        li_freq5.append(max(li_freq1[-1],li_freq2[-1],li_freq3[-1],li_freq4[-1]))
        li_freq6.append(min(li_freq1[-1],li_freq2[-1],li_freq3[-1],li_freq4[-1]))
...
#    base['tt05'] = li_tt05
    ...
    base['t_r8'] = base['t3_03']/merged['t_len']
    base['t_r9'] = base['t3_04']/merged['t_len']
...
#    base['d3_07'] = li_d3_07
    ...
    base['d_r8'] = base['d3_02']/merged['d_len']
    base['d_r9'] = base['d3_03']/merged['d_len']
