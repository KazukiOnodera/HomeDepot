...
#    
    ...
    li_freq1,li_freq2,li_freq3,li_freq4 = [],[],[],[]
    ...
    for i in merged.index:
        ...
        li_t_p01.append(hdm.ispair(query,tt))
        li_t_p02.append(hdm.ispair(query[::-1],tt[::-1]))
        ...
        li_d_p01.append(hdm.ispair(query,desc))
        li_d_p02.append(hdm.ispair(query[::-1],desc[::-1]))
        ...
        li_freq3.append(max(li_freq1[-1],li_freq2[-1]))
        li_freq4.append(min(li_freq1[-1],li_freq2[-1]))
